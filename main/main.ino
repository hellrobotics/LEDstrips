...
Adafruit_NeoPixel leftStrip = Adafruit_NeoPixel(16, LEFTPIN, NEO_GRB + NEO_KHZ800);
Adafruit_NeoPixel rightStrip = Adafruit_NeoPixel(16, RIGHTPIN, NEO_GRB + NEO_KHZ800);
...
void loop() {
  ...
  colorWipe(leftStrip.Color(255, 0, 0), 50, &leftStrip); // Red
